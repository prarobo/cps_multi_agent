/*
 * findEnergyGame_mod_emxutil.h
 *
 * Code generation for function 'findEnergyGame_mod_emxutil'
 *
 */

#ifndef __FINDENERGYGAME_MOD_EMXUTIL_H__
#define __FINDENERGYGAME_MOD_EMXUTIL_H__
...
/* End of code generation (findEnergyGame_mod_emxutil.h) */
